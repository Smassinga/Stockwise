...
No route path, role, permission, RLS policy, migration, stock authority, costing rule, POS behavior, dependency, Sentry setting, or workflow trigger changes in UX-4. Local and release validation evidence will be appended only after the corresponding gates pass. UXF-10 is locally addressed but remains open until rollout verification. UX-5 Sales and Purchasing remains next; UX-6 through UX-10 retain their order.
