...
## POS tax applicability rollout (2026-07-16)

Implementation `f559f253c70823786c2ebd388bab3b26c02262b7` passed Validation `29515956021`, job `87680918687`. Isolated-workflow compatibility commit `046d4500ed58e57711460f0d517a1995bf6cbe4f` passed Validation `29516389860`, job `87682378112`; manual Finance Regression (Isolated) run `29516469375`, job `87682655940`, replayed all 45 migrations, passed `393/393`, and completed cleanup without a success artifact.
