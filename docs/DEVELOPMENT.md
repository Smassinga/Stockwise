...
Current release state: hosted production and local replay have 38 active migrations through `20260704041943_add_growth_batch_completion_posting.sql`. Growth Batches G5.1 depleting harvest/event-specific harvest reversal and G5.2 completion/event-specific completion reversal are live and production-smoke validated.
