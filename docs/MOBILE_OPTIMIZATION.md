...
- growth-batch cards and detail sections should show status, family, basis quantity, latest weight, memo/direct/material costs, location, measurements, stock-input history, G4.1 loss history, and event timeline without requiring horizontal scrolling
