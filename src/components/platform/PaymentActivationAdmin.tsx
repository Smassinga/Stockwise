...
export default function PaymentActivationAdmin({ locale, onOpenCompany, tt }: Props) {
  ...
  const statusLabel = (value: string) => tt(`paymentActivation.status.${value}`, value.replaceAll('_', ' '))
  const eventLabel = (value: string) => tt(`paymentActivation.event.${value}`, value.replaceAll('_', ' '))
  const periodLabel = (value: string) => tt(`paymentActivation.period.${value}`, value.replaceAll('_', ' '))
  const providerLabel = (value: string) => tt(`paymentActivation.provider.${value}`, value.replaceAll('_', ' '))
