...
export function EmailTemplateLab({ language }: { language: 'en' | 'pt' }) {
  ...
  return <Card>
    ...
    <CardContent className="space-y-5">
      ...
      {previewMetadata ? <div className="grid gap-2 rounded-xl border bg-muted/20 p-4 text-xs md:grid-cols-3">
        <div><span className="font-semibold">Scenario</span><br />{previewMetadata.scenarioLabel}</div>
