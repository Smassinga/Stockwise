...
const GENERATED_UOM_CODE_RE = /^(?:UI-[A-Z0-9]+|(?:EA|EACH|PCS|PAIR|SET|PACK|BOX|BAG|CASE|CARTON|ROLL|SHEET|MG|G|KG|T|MM|CM|M|KM|CM2|M2|ML|L|M3|MIN|HOUR|DAY|PALLET|CRATE|BUNDLE)-[A-F0-9]{8}|[A-Z0-9]+-[A-Z0-9-]+-(EA|EACH|PCS|PAIR|SET|PACK|BOX|BAG|CASE|CARTON|ROLL|SHEET|MG|G|KG|T|MM|CM|M|KM|CM2|M2|ML|L|M3|MIN|HOUR|DAY|PALLET|CRATE|BUNDLE))$/
