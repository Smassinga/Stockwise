...
const css = `
@page{size:A4;margin:14mm}*{box-sizing:border-box}html,body{margin:0;padding:0;background:#fff;color:#111311;font:10.8px/1.45 "Aptos","Segoe UI",Arial,sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact}.doc{width:100%}.sheet{border:1px solid #a1a7a2;padding:18px 18px 14px}.header{display:grid;grid-template-columns:minmax(0,1fr) 248px;gap:18px;align-items:start;margin-bottom:14px}.seller{border:1px solid #a1a7a2;display:grid;grid-template-columns:88px minmax(0,1fr);gap:14px;padding:14px 16px}.logoWrap{display:flex;align-items:flex-start;justify-content:center}.logoMark{width:68px;height:68px;border:1px solid #a1a7a2;display:flex;align-items:center;justify-content:center;overflow:hidden;background:#fff}.logo{display:block;width:100%;height:100%;object-fit:contain}.logoFallback{display:flex;align-items:center;justify-content:center;width:100%;height:100%;font-size:21px;font-weight:800;letter-spacing:.06em;color:#b91c1c}.sellerCopy{min-width:0}.brand{font-size:10px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#5c625d}.docType{margin:2px 0 10px;font-size:17px;font-weight:800;letter-spacing:.03em;color:#181a18}.sellerLine{margin:2px 0;color:#3f443f}.sellerStrong{font-weight:800;color:#111311}.meta{border:1px solid #a1a7a2}.metaTable,.dataTable,.lineTable,.bankTable,.totalsTable{width:100%;border-collapse:collapse;table-layout:fixed}.metaTable td,.metaTable th,.dataTable td,.lineTable td,.lineTable th,.bankTable td,.bankTable th,.totalsTable td,.totalsTable th{border:1px solid #a1a7a2;padding:6px 8px;vertical-align:top}.metaTable th,.dataTable th,.lineTable th,.bankTable th,.totalsTable th{background:#f7f8f7;color:#252925;font-size:9px;font-weight:800;letter-spacing:.04em;text-transform:uppercase}.metaLabel,.dataLabel,.totalsLabel{width:42%;font-size:9px;font-weight:700;color:#5c625d}.metaValue,.dataValue,.totalsValue{font-weight:700;color:#111311}.docBlock{margin-bottom:12px}.docBlock:last-child{margin-bottom:0}.blockTitle{margin:0 0 6px 0;font-size:9.3px;font-weight:800;letter-spacing:.05em;text-transform:uppercase;color:#252925}.counterparty{margin-bottom:12px}.lineTable thead th{text-align:left}.lineDesc{font-weight:700;color:#111311}.lineMeta{margin-top:3px;font-size:8.7px;color:#737a74}.r{text-align:right}.tv{display:inline-block;white-space:nowrap;font-variant-numeric:tabular-nums}.summary{display:grid;grid-template-columns:minmax(0,1fr) 214px;gap:16px;align-items:start;margin-top:14px}.stack{display:grid;gap:10px;grid-column:1;grid-row:1}.totalsPane{grid-column:2;grid-row:1}.panel{border:1px solid #a1a7a2;padding:10px 12px;page-break-inside:avoid;white-space:pre-line}.panelMuted{color:#5c625d}.bankGroup+.bankGroup{margin-top:8px}.bankHeading{margin:0 0 6px 0;font-size:9px;font-weight:800;letter-spacing:.04em;text-transform:uppercase;color:#3f443f}.totalsTable td,.totalsTable th{padding:7px 8px}.totalsTable th{background:#f7f8f7}.totalsTable .grand td{font-size:12px;font-weight:800}.totalsTable .sectionHead th{font-size:9.1px}.footer{display:flex;justify-content:space-between;gap:12px;margin-top:14px;padding-top:8px;border-top:1px solid #a1a7a2;font-size:8.5px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;color:#5c625d}.footerRight{text-align:right}@media print{.sheet{border:none;padding:0}.footer{position:static}}
`
