async (page) => {
  ...
  await page.locator('#email').fill('uimoj5spvy.invited.581d04d1@stockwise.local')
  await page.locator('#password').fill('Sw!581d04d1Aa11')
  ...
  await page.screenshot({ path: 'C:/Dev/Stockwise/output/playwright/04-invited-onboarding-desktop.png', fullPage: true })
  const beforeText = await page.locator('body').innerText()
  await page.getByRole('button', { name: 'Accept invitation' }).click()
  await page.getByText('Invitation accepted. Entering').waitFor({ timeout: 10000 })
  await page.waitForURL('**/dashboard', { timeout: 20000 })
  await page.waitForLoadState('networkidle')
  await page.screenshot({ path: 'C:/Dev/Stockwise/output/playwright/05-invited-dashboard-desktop.png', fullPage: true })
  return {
    url: page.url(),
